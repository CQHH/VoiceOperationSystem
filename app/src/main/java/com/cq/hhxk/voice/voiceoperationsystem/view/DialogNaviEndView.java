 ...
 * @author enmaoFu
 */
public class DialogNaviEndView extends Dialog {
    ...
    private TextView openMeals;

    public DialogNaviEndView(Context context) {
        super(context);
    }
    ...
    public void init(){
        ...
        openMeals = (TextView)findViewById(R.id.open_meals);
    }
    ...
    public void setOnClickOpenApp(View.OnClickListener click){
        openMeals.setOnClickListener(click);
    }
