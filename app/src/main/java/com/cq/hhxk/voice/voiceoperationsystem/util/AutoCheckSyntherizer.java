...
public class AutoCheckSyntherizer {
    private static AutoCheckSyntherizer instance;
     ...
     * @return
     */
    public static AutoCheckSyntherizer getInstance(Context context) {
        if (instance == null || AutoCheckSyntherizer.context != context) {
            instance = new AutoCheckSyntherizer(context);
        }
        return instance;
    }
    ...
    public void check(final InitConfig initConfig, final Handler handler) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                AutoCheckSyntherizer obj = innerCheck(initConfig);
                isFinished = true;
    ...
    private AutoCheckSyntherizer innerCheck(InitConfig config) {
    ...
    private AutoCheckSyntherizer(Context context) {
