...
public class AutoCheckRecog {
    ...
    public AutoCheckRecog(Context context, final Handler handler, boolean enableOffline) {
    ...
    public void checkAsr(final Map<String, Object> params) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                AutoCheckRecog obj = checkAsrInternal(params);
                name = "识别";
    ...
    private AutoCheckRecog checkAsrInternal(Map<String, Object> params) {
