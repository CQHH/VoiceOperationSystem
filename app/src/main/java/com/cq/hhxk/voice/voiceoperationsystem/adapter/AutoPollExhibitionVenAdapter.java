...
public class AutoPollExhibitionVenAdapter extends RecyclerView.Adapter<AutoPollExhibitionVenAdapter.BaseViewHolder> {
    private final List<ExhibitionVENPojo> mData;

    public AutoPollExhibitionVenAdapter(List<ExhibitionVENPojo> mData) {
        this.mData = mData;
    }
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ExhibitionVENPojo data = mData.get(position % mData.size());
