...
/**
 * @title  基础的Fragment,实现懒加载,显示进度条的时候尽量放在onActivityCreated,用于Viewpage中
 * @date   2017/06/17
 * @author enmaoFu
 */
public abstract class BaseLazyFragment extends Fragment implements HttpCallBack{
    ...
    /**
     * 设置懒加载
     * 默认先只加载FragmentA，具体滑动到了哪个Fragment，再去加载该Fragment的数据
     */
    ...
    public void doHttp(Call<ResponseBody> bodyCall, final int what) {
        bodyCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (object.containsKey("code")) {
                        ...
                        if (code == 200) {
                            BaseLazyFragment.this.onSuccess(result, call, response, what);
                        } else {
                            BaseLazyFragment.this.onFailure(result, call, response, what);
                        }
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                BaseLazyFragment.this.onError(call, t, what);
